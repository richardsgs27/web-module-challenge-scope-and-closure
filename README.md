...
1. In your own words, define closure (1-2 sentences).
   Answer: Closure gives access to an outer function from an inner function.
...
Answer: the same is Dans dice rolling twice, what can change is the number he rolls.

c. What is the lexical scope of `newRoll`?
Answer: Calling the variable inside the same function.
