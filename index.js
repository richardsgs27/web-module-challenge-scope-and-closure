...
/*Task 1: counterMaker()
  ...
  Answer: counter1 has closure and counter2 doesnt.

  2. Which of the two uses a closure? How can you tell?
  Answer: counter1, because theres a function on the inside calling a variable in the outer function.

  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     Answer: counter2 would be better if you only need one, but counter1 would be better if you needed multiple counters at the same time.
*/
